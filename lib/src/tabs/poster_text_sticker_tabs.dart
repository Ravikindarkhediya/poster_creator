...
class PosterTextTab extends StatelessWidget {
  ...
  static final _paletteColors = <Color>[
    Colors.white,
    Colors.black,
    Colors.blueAccent,
    ...
    return ListenableBuilder(
      ...
      builder: (_, __) {
        ...
        final editing =
            sel != null &&
            sel.isText &&
            (sel.socialPlatform == null || sel.socialPlatform!.isEmpty);
  ...
  Widget _emptyState(BuildContext ctx) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      const Text(
        'SELECT STYLE TO ADD TEXT',
        style: TextStyle(
          fontSize: 10,
        ...
        child: ListView.separated(
          ...
          itemBuilder: (_, i) {
            ...
            return GestureDetector(
              onTap: () =>
                  controller.addTextSticker('Double-tap to edit', style: p),
              child: Container(
  ...
  Widget _editPanel(BuildContext ctx, PosterStickerModel s) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      const Text(
        'TEXT PRESETS',
      ...
      SizedBox(
        ...
        child: ListView.separated(
          ...
          itemBuilder: (_, i) {
            ...
            return GestureDetector(
              onTap: () => controller.updateSelectedStickerStyle(p),
              child: Container(
                padding: const EdgeInsets.symmetric(horizontal: 10),
                decoration: BoxDecoration(
      ...
      SizedBox(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (_, i) {
            final font = _fonts[i];
            final isSel = s.fontFamily == font;
            return GestureDetector(
              onTap: () =>
                  controller.updateSticker(s.copyWith(fontFamily: font)),
        ...
        children: [
          ...
          Expanded(
            child: SliderTheme(
              ...
              child: Slider(
                value: s.fontSize.clamp(8, 100),
                min: 8,
                max: 100,
                onChanged: (v) => controller.updateSelectedStickerFontSize(v),
              ),
            ),
          ),
          Text(
      ...
      _colorRow(
        ...
        s.textColor,
        true,
        (c) => controller.updateSticker(s.copyWith(textColor: c)),
      ),
      const SizedBox(height: 12),
      const Text(
        'BACKGROUND COLOR',
      ...
      _colorRow(
        ...
        true,
        (c) => controller.updateSticker(
          s.copyWith(backgroundColor: c == Colors.transparent ? null : c),
        ),
      ),
    ],
  );
  ...
  Widget _colorRow(
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        scrollDirection: Axis.horizontal,
        itemCount: colors.length + 1 + (showClear ? 1 : 0),
        itemBuilder: (_, i) {
          if (showClear && i == 0) {
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: Colors.white,
                  border: Border.all(
                    color: none ? Colors.blueAccent : Colors.grey.shade300,
                    width: none ? 2 : 1,
                  ),
                ),
                child: Icon(
                  ...
                  size: 18,
                  color: none ? Colors.blueAccent : Colors.grey.shade400,
                ),
              ),
            );
          }
          ...
          if (ci == colors.length) {
            return GestureDetector(
              onTap: () => _pickCustomColor(ctx, active, onTap),
              child: Container(
                width: 32,
                decoration: BoxDecoration(
                  shape: BoxShape.circle,
          ...
          final c = colors[ci];
          final isSel = c.value == active.value;
          return GestureDetector(
            onTap: () => onTap(c),
            child: Container(
              width: 32,
...
class PosterStickerTab extends StatelessWidget {
  ...
  Widget _stickerCell(String url, VoidCallback onTap) => InkWell(
    onTap: onTap,
