...
class PosterFrameModel {
  ...
  factory PosterFrameModel.wavyProfile() => const PosterFrameModel(
        id: 'wavyProfile', displayName: 'Wavy Profile',
        type: PosterFrameType.wavyProfile,
        backgroundColor: Color(0xFFFF9933),
        textColor1: Colors.white, textColor2: Color(0xFFFFFF00),
        nameFontSize: 22, designationFontSize: 14,
      );

  factory PosterFrameModel.modernAngled() => const PosterFrameModel(
        id: 'modernAngled', displayName: 'Modern Angled',
        type: PosterFrameType.modernAngled,
        backgroundColor: Color(0xFFFF9933),
        color1: Color(0xFFFFFF00), textColor: Colors.white,
        textColor1: Colors.black, textColor2: Colors.white,
        nameFontSize: 20, designationFontSize: 14,
      );

  factory PosterFrameModel.sleekRibbon() => const PosterFrameModel(
        id: 'sleekRibbon', displayName: 'Sleek Ribbon',
  ...
  factory PosterFrameModel.cleanBar() => const PosterFrameModel(
        id: 'cleanBar', displayName: 'Clean Bar',
        type: PosterFrameType.cleanBar,
        backgroundColor: Color(0xFFFF9933), color1: Colors.white,
        textColor1: Color(0xFFFF9933), textColor2: Colors.white,
        nameFontSize: 18, designationFontSize: 14,
      );

  factory PosterFrameModel.footerStrip() => const PosterFrameModel(
        id: 'footerStrip', displayName: 'Footer Strip',
        type: PosterFrameType.footerStrip,
        color1: Colors.white, color2: Color(0xFFFF9933),
        textColor1: Color(0xFFFF9933), textColor2: Colors.black,
        nameFontSize: 20, designationFontSize: 12,
      );

  factory PosterFrameModel.floatingCard() => const PosterFrameModel(
        id: 'floatingCard', displayName: 'Floating Card',
        type: PosterFrameType.floatingCard,
        color1: Colors.white,
        textColor1: Colors.black, textColor2: Color(0xFF212121),
        nameFontSize: 20, designationFontSize: 12,
      );

  factory PosterFrameModel.saffronPride() => const PosterFrameModel(
        id: 'saffronPride', displayName: 'Saffron Pride',
        type: PosterFrameType.saffronPride,
        color1: Color(0xFFFFB74D), color2: Color(0xFFFF9933),
        textColor1: Colors.white, textColor2: Colors.white,
        nameFontSize: 24, designationFontSize: 14,
      );

  factory PosterFrameModel.tricolorStrip() => const PosterFrameModel(
        id: 'tricolorStrip', displayName: 'Tricolor Strip',
        type: PosterFrameType.tricolorStrip,
        color1: Color(0xFFFF9933), color2: Colors.white,
        color3: Color(0xFF128807), textColor1: Colors.black,
        nameFontSize: 16,
      );

  factory PosterFrameModel.rajnetaPremium() => const PosterFrameModel(
        id: 'rajnetaPremium', displayName: 'Rajneta Premium',
        type: PosterFrameType.rajnetaPremium,
        color1: Colors.white, color2: Color(0xFFFF9933),
        textColor1: Color(0xFFFF9933), textColor2: Colors.black,
        nameFontSize: 30, designationFontSize: 16,
      );

  factory PosterFrameModel.rajnetaModern() => const PosterFrameModel(
        id: 'rajnetaModern', displayName: 'Rajneta Modern',
        type: PosterFrameType.rajnetaModern,
        color1: Color(0xFFFF9933),
        textColor1: Colors.white, textColor2: Colors.white,
        nameFontSize: 28, designationFontSize: 16,
      );

  factory PosterFrameModel.rajnetaClassic() => const PosterFrameModel(
        id: 'rajnetaClassic', displayName: 'Rajneta Classic',
        type: PosterFrameType.rajnetaClassic,
        color1: Color(0xFFFF9933),
        textColor1: Colors.white, textColor2: Colors.white,
        nameFontSize: 26, designationFontSize: 15,
      );

  factory PosterFrameModel.wavyEdge() => const PosterFrameModel(
        id: 'wavyEdge', displayName: 'Wavy Edge',
  ...
  factory PosterFrameModel.simpleFull() => const PosterFrameModel(
        id: 'simpleFull', displayName: 'Simple Full',
        type: PosterFrameType.simpleFull,
        color1: Color(0xFFFF9933), color2: Color(0xFF128807),
        textColor1: Colors.white, textColor2: Colors.white,
        nameFontSize: 28, designationFontSize: 16,
      );

  factory PosterFrameModel.diagonalSlash() => const PosterFrameModel(
        id: 'diagonalSlash', displayName: 'Diagonal Slash',
        type: PosterFrameType.diagonalSlash,
        color1: Color(0xFFFF9933), color2: Color(0xFFFF6600),
        textColor1: Colors.white, textColor2: Color(0xFFFFE0B2),
        nameFontSize: 22, designationFontSize: 13,
      );

  factory PosterFrameModel.premiumGlassCard() => const PosterFrameModel(
        id: 'premiumGlassCard', displayName: 'Glass Card',
        type: PosterFrameType.premiumGlassCard,
        color1: Color(0xFFFF9933), color2: Color(0xFFFF6600),
        textColor1: Colors.white, textColor2: Color(0xFFFFE0B2),
        nameFontSize: 20, designationFontSize: 13,
      );

  factory PosterFrameModel.arcReveal() => const PosterFrameModel(
        id: 'arcReveal', displayName: 'Arc Reveal',
        type: PosterFrameType.arcReveal,
        color1: Color(0xFFFF9933), color2: Color(0xFFFFB74D),
        textColor1: Colors.white, textColor2: Color(0xFFFFE0B2),
        nameFontSize: 22, designationFontSize: 13,
      );

  factory PosterFrameModel.centerStage() => const PosterFrameModel(
        id: 'centerStage', displayName: 'Center Stage',
        type: PosterFrameType.centerStage,
        color1: Color(0xFF1a1a2e), color2: Color(0xFFFF9933),
        textColor1: Colors.white, textColor2: Color(0xFFFFE0B2),
        nameFontSize: 24, designationFontSize: 14,
      );

  factory PosterFrameModel.cornerBadge() => const PosterFrameModel(
        id: 'cornerBadge', displayName: 'Corner Badge',
  ...
  factory PosterFrameModel.dualTone() => const PosterFrameModel(
        id: 'dualTone', displayName: 'Dual Tone',
  ...
  factory PosterFrameModel.triColorModern() => const PosterFrameModel(
        id: 'triColorModern', displayName: 'Tri Color Modern',
  ...
  factory PosterFrameModel.wavyProfileTop() => const PosterFrameModel(
        id: 'wavyProfileTop', displayName: 'Wavy (Top)',
  ...
  factory PosterFrameModel.cleanBarTop() => const PosterFrameModel(
        id: 'cleanBarTop', displayName: 'Clean Bar (Top)',
  ...
  factory PosterFrameModel.floatingCardTop() => const PosterFrameModel(
        id: 'floatingCardTop', displayName: 'Floating Card (Top)',
  ...
  factory PosterFrameModel.footerStripTop() => const PosterFrameModel(
        id: 'footerStripTop', displayName: 'Footer Strip (Top)',
  ...
  factory PosterFrameModel.modernAngledTop() => const PosterFrameModel(
        id: 'modernAngledTop', displayName: 'Angled (Top)',
        type: PosterFrameType.modernAngledTop,
        backgroundColor: Color(0xFFFF9933), color1: Color(0xFFFFFF00),
        textColor: Colors.white, textColor1: Colors.black,
        nameFontSize: 20, designationFontSize: 14,
      );

  factory PosterFrameModel.sleekRibbonTop() => const PosterFrameModel(
        id: 'sleekRibbonTop', displayName: 'Ribbon (Top)',
  ...
  factory PosterFrameModel.saffronPrideTop() => const PosterFrameModel(
        id: 'saffronPrideTop', displayName: 'Saffron (Top)',
  ...
  factory PosterFrameModel.tricolorStripTop() => const PosterFrameModel(
        id: 'tricolorStripTop', displayName: 'Tricolor (Top)',
  ...
  factory PosterFrameModel.rajnetaPremiumTop() => const PosterFrameModel(
        id: 'rajnetaPremiumTop', displayName: 'Premium (Top)',
  ...
  factory PosterFrameModel.rajnetaClassicTop() => const PosterFrameModel(
        id: 'rajnetaClassicTop', displayName: 'Classic (Top)',
