  ...
  Widget build({
    ...
    return Positioned(
      ...
      child: Stack(
        ...
        children: [
          ClipPath(
            clipper: NotchClipper(avatarRadius: ar, centerX: cx),
            child: Container(
              height: sh,
              width: double.infinity,
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [c.frameColor1, c.frameColor2],
                ),
                boxShadow: [
                  BoxShadow(
            ...
            child: Stack(
              children: [
                Positioned(
                  ...
                  right: 0,
                  height: 4,
                  child: Container(color: c.frameColor2),
                ),
                Padding(
                  padding: EdgeInsets.only(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            ...
            child: Container(
              color: c.frameColor2,
              padding: EdgeInsets.symmetric(horizontal: canvasWidth * 0.04),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
  ...
  Widget build({
    ...
    return Positioned(
      ...
      child: Stack(
        ...
        children: [
          ClipPath(
            clipper: NotchClipperBottom(avatarRadius: ar, centerX: cx),
            child: Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [c.frameColor1, c.frameColor2],
    ...
    return Positioned(
      ...
      child: Stack(
        ...
        children: [
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(colors: [c.frameColor1, c.frameColor2]),
            ),
          ),
          Positioned(
            left: al + ar * 2 + canvasWidth * 0.05,
